...
*/
            ...
            PreparedStatement insertClasses = conndb.prepareStatement("INSERT INTO Classes(courseID, studentID, section, year, semester, grade)"
                    + "VALUES(22100,1,321,2021,'Spring','B'),"
                    + "(22100,2,321,2021,'Spring','B'),"
                    + "(22100,3,321,2021,'Spring','A'),"
                    + "(22100,4,321,2021,'Spring','C'),"
                    + "(22100,5,321,2021,'Spring','B'),"
                    + "(22100,6,321,2021,'Spring','C'),"
                    + "(22100,7,321,2021,'Spring','A'),"
                    + "(22100,8,321,2021,'Spring','F'),"
                    + "(22100,9,321,2021,'Spring','A'),"
                    + "(22100,10,321,2021,'Spring','C'),"
                    + "(22100,11,321,2021,'Spring','A'),"
                    + "(22100,12,321,2021,'Spring','A'),"
                    + "(22100,13,321,2021,'Spring','W'),"
                    + "(22100,14,321,2021,'Spring','C'),"
                    + "(22100,15,321,2021,'Spring','W'),"
                    + "(22100,16,321,2021,'Spring','B'),"
                    + "(22100,17,321,2021,'Spring','B'),"
                    + "(22100,18,321,2021,'Spring','F'),"
                    + "(22100,19,321,2021,'Spring','A'),"
                    + "(22100,20,321,2021,'Spring','C'),"
                    + "(22100,21,321,2021,'Spring','B'),"
                    + "(22100,22,321,2021,'Spring','A'),"
                    + "(22100,23,321,2021,'Spring','A'),"
                    + "(22100,24,321,2021,'Spring','D'),"
                    + "(22100,25,321,2021,'Spring','F')");
